...
public class DefaultIATDeployer implements IATDeployer {
    ...
    public Long getDeploymentId() {
        return this.deploymentSessionId;
    }
    ...
    public void setRepositoryManager(IATRepositoryManager repositoryManager) {
        this.iatRepositoryManager = repositoryManager;
    }
