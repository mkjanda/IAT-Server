...
public class TestSegment implements java.io.Serializable {
    ...
    private String html, headerScript, script;
    ...
    public TestSegment(IAT test, String elementName, String html, int alternationPriority, int initialPos, int alternationNum, boolean iat) {
        this.test = test;
        this.elementName = elementName;
        this.html = html;
        this.alternationPriority = alternationPriority;
        this.initialPos = initialPos;
        this.numAlternations = alternationNum;
        this.iat = iat;
    }
    ...
    public void setHeaderScript(String val) {
        this.headerScript = val;
    }
