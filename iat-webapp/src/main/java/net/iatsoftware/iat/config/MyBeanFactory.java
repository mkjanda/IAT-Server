...
public interface MyBeanFactory {
   IATDeployer IATDeployer(Long clientID, Long deploymentID, Long testID, String sessionID);
   IATRedeployer IATRedeployer(Long clientID, Long deploymentID, Long replaceementTestID, Long oldTestID, String sessionID);
