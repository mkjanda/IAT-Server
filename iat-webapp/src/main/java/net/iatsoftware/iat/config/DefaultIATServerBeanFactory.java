...
public class DefaultIATServerBeanFactory implements MyBeanFactory {
    ...
    @Override
    public IATDeployer IATDeployer(Long clientID, Long deploymentID, Long testID, String sessionID) {
        return (IATDeployer)ctx.getBean("DefaultIATDeployer", clientID, deploymentID, testID, sessionID);
    }
    
    @Override
    public IATRedeployer IATRedeployer(Long clientID, Long deploymentID, Long replacementTestID, Long oldTestID, String sessionID) {
        return (IATRedeployer)ctx.getBean("DefaultIATRedeployer", clientID, deploymentID, replacementTestID, oldTestID, sessionID);
    }
