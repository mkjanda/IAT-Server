...
public class AdminController {
	...
	@RequestMapping(value = "/resources/{clientId}/{testName}/{resourceName}")
	public ResponseEntity<byte[]> getTestResource(@PathVariable(name = "clientId", required = true) Long clientId,
			...
			@PathVariable(name = "resourceName", required = true) String resourceName) {
		var test = iatRepositoryManager.getIATByNameAndClientID(testName, clientId);
		var res = iatRepositoryManager.getTestResource(test, resourceName);
