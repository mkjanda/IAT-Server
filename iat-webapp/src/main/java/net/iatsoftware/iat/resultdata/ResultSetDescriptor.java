...
public class ResultSetDescriptor extends net.iatsoftware.iat.generated.ResultSetDescriptorPojo {
    ...
    public void load(Long clientID, String testName) throws java.io.IOException, java.net.URISyntaxException {
        ...
        var cfData = iatRepositoryManager.getTestResource(test, testName).getResource();
        ...
        for (var survey : cf.getIATSurvey()) {
            var surveyB64 = encoder.encodeToString(iatRepositoryManager.getTestResource(test, survey.getSurveyName()).getResource());
