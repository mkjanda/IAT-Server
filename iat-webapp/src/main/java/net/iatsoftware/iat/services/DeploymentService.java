...
public interface DeploymentService {
    long beginNewDeployment(Client c, String testName, SessionState session, ReplyChannel replyChannel) throws java.io.IOException, java.net.URISyntaxException;
