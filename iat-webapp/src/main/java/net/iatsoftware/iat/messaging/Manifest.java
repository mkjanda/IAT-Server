...
public class Manifest extends net.iatsoftware.iat.generated.ManifestPojo {
    ...
    private static java.io.File[] getDepreciatedUpdateDirectoryCandidates(java.io.File rootPath, String clientRelease) {
        ...
        final Pattern dirPattern = Pattern.compile(".+\\.([1-9][0-9]*)-([0-9]+)-([0-9]+)-([0-9]+)$");
    ...
    public static UpdateNotification getUpdateNotification(java.io.File rootPath, String clientRelease) {
        UpdateNotification updateNotification = new UpdateNotification();
        java.io.File[] notificationDirectoryCandidates = Manifest.getUpdateDirectoryCandidates(rootPath, clientRelease);
        byte[] buff = new byte[8192];
