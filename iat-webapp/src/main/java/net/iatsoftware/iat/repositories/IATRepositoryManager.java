...
public interface IATRepositoryManager {
    ...
    void addEncryptionKey(IAT test, Crypt key);
    ...
    Long registerIAT(Client c, String iatName, int testSizeKB);
    ...
    Crypt getEncryptionKey(IAT test);
    ...
    Crypt getDataKey(Long clientID, String testName);
    ...
    void storeEncryptionKey(Crypt key);
    void updateEncryptionKey(Crypt key);
    ...
    Crypt getRSAKey(Long clientID, String testName);
