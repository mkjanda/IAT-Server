 ...
 *       &lt;sequence&gt;
 *         &lt;element name="DataKey" type="{http://www.iatsoftware.net/schema}encrypted-rsa-key-impl"/&gt;
 *         &lt;element name="AdminKey" type="{http://www.iatsoftware.net/schema}encrypted-rsa-key-impl"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    extends Message
{
    ...
    protected EncryptedRSAKey dataKey;
    @XmlElement(name = "AdminKey", required = true)
    protected EncryptedRSAKey adminKey;
     ...
     *     
     */
    public void setDataKey(EncryptedRSAKey value) {
        this.dataKey = value;
    }
     ...
     *     
     */
    public EncryptedRSAKey getAdminKey() {
        return adminKey;
    }
     ...
     *     
     */
    public void setAdminKey(EncryptedRSAKey value) {
        this.adminKey = value;
    }
