...
public class ObjectFactory {
    ...
    private final static QName _GTransactionRequestDeploymentId_QNAME = new QName("", "DeploymentId");
    private final static QName _GTransactionRequestDeploymentStartTime_QNAME = new QName("", "DeploymentStartTime");
    private final static QName _GTransactionRequestEmail_QNAME = new QName("", "Email");
    private final static QName _GTransactionRequestAuthToken_QNAME = new QName("", "AuthToken");
    private final static QName _GTransactionRequestEncryptedTestString_QNAME = new QName("", "EncryptedTestString");
     ...
     */
    @XmlElementDecl(namespace = "", name = "DeploymentId", scope = GTransactionRequest.class)
    public JAXBElement<Long> createGTransactionRequestDeploymentId(Long value) {
        return new JAXBElement<Long>(_GTransactionRequestDeploymentId_QNAME, Long.class, GTransactionRequest.class, value);
    }
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link Long }{@code >}
     */
    @XmlElementDecl(namespace = "", name = "DeploymentStartTime", scope = GTransactionRequest.class)
    public JAXBElement<Long> createGTransactionRequestDeploymentStartTime(Long value) {
        return new JAXBElement<Long>(_GTransactionRequestDeploymentStartTime_QNAME, Long.class, GTransactionRequest.class, value);
    }
     ...
     */
    @XmlElementDecl(namespace = "", name = "Email", scope = GTransactionRequest.class)
    public JAXBElement<String> createGTransactionRequestEmail(String value) {
        return new JAXBElement<String>(_GTransactionRequestEmail_QNAME, String.class, GTransactionRequest.class, value);
    }
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link String }{@code >}
     */
    @XmlElementDecl(namespace = "", name = "AuthToken", scope = GTransactionRequest.class)
    public JAXBElement<String> createGTransactionRequestAuthToken(String value) {
        return new JAXBElement<String>(_GTransactionRequestAuthToken_QNAME, String.class, GTransactionRequest.class, value);
    }
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link String }{@code >}
     */
    @XmlElementDecl(namespace = "", name = "EncryptedTestString", scope = GTransactionRequest.class)
    public JAXBElement<String> createGTransactionRequestEncryptedTestString(String value) {
        return new JAXBElement<String>(_GTransactionRequestEncryptedTestString_QNAME, String.class, GTransactionRequest.class, value);
    }
